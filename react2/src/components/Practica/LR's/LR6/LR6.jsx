        ...
        <div className={s.wrapper}>
            <div className={s.first}>
                ...
                <div className={s.pole1}>
                    ...
                    <textarea placeholder='Shifr message' rows={1} id="shifr_message_ex6_1"></textarea>
                </div>
            </div>
            <div className={s.second}>
                ...
                <div className={s.pole1}>
                    <div className={s.right}>
                        ...
                        <textarea placeholder='Введите q' rows={1} id="field_ex6_1_q"></textarea>
                        <textarea placeholder='Введите e' rows={1} id="field_ex6_1_e"></textarea>
                        <textarea placeholder='Введите k' rows={1} id="field_ex6_1_k"></textarea>
                    ...
                    <textarea placeholder='Shifr message' rows={1} id="shifr_message_ex6_2"></textarea>
                </div>
            </div>
        </div>
    );
